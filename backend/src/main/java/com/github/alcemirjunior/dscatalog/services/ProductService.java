...
public class ProductService {
    ...
    public Page<ProductDTO> findAllPaged(Long categoryId, String name, PageRequest pagedRequest){
        List <Category> categories = (categoryId == 0) ? null : Arrays.asList(categoryRepository.getOne(categoryId));
        Page<Product> list = repository.find(categories, name, pagedRequest);
