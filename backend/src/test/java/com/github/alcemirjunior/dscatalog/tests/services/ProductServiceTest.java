package com.github.alcemirjunior.dscatalog.tests.services;
...
import com.github.alcemirjunior.dscatalog.services.ProductService;
...
//precisa "mokar" uma dependencia pro repository com o @Mock

@ExtendWith(SpringExtension.class)
public class ProductServiceTest {

    @InjectMocks//marcação na classe que está sendo testada
    private ProductService service;

    @Mock //classe que tem a dependencia
    ...
    void setUp ()  throws Exception{
        ...
        //comportamentos simulado mockito
        //quando tem retorono utilizar o when -> then
        //quando é void -> doAlgumaCoisa depois when
    ...
    @Test
    public void updateShouldTrowsResourceNotFoundExceptionWhenIdDoesNotExists(){
    ...
    @Test
    public void findByIdShouldTrowsResourceNotFoundExcepetionWhenIdDoesNotExists(){
    ...
    @Test
    public void deleteShouldTrowsEmptyResourceNotFoundExceptionWhenIdDoesNotExists(){
